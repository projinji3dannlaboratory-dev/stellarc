# STELLARC v2 — 宇宙探索型・企業発見プラットフォーム

全上場企業（約3,800社）を銀河に見立てて探索するWebアプリ。

- **星の大きさ = 時価総額**（対数スケール。データ無しの星は従業員数で代替）
- **星の輝き = 優良企業度**（売上成長率20pt・営業利益率25pt・働きやすさ30pt・平均年収25pt の独自スコア、満点100）
